...
//
// Helper: Draws a horizontal line
//
...
// Add this helper for solid vertical lines to prevent the "chopped" look
void DrawVLineSolid(int x, int y1, int y2, int color)
{
...
void DrawBigTitle(int x, int y)
{
	...
	// --- B ---
	// Use DrawVLineSolid instead of DrawVLine to ensure solid pillars
	DrawVLineSolid(x, y, y+h, 1);
	DrawVLineSolid(x+1, y, y+h, 1);
	DrawHLine(x, x+w-3, y, 1);
	DrawHLine(x, x+w-3, y+8, 1);
	DrawHLine(x, x+w-3, y+h, 1);
	DrawVLineSolid(x+w-2, y+1, y+7, 1);
	DrawVLineSolid(x+w-2, y+9, y+h-1, 1);
	SetPixel(x+w-1, y+2, 1); SetPixel(x+w-1, y+6, 1);
	SetPixel(x+w-1, y+10, 1); SetPixel(x+w-1, y+h-2, 1);

	// --- O ---
	x += s;
	DrawVLineSolid(x, y+2, y+h-2, 1);
	DrawVLineSolid(x+1, y+2, y+h-2, 1);
	DrawVLineSolid(x+w-1, y+2, y+h-2, 1);
	DrawVLineSolid(x+w, y+2, y+h-2, 1);
	...
	DrawVLineSolid(x, y, y+h, 1);
	DrawVLineSolid(x+1, y, y+h, 1);
	DrawVLineSolid(x+w-1, y, y+h, 1);
	DrawVLineSolid(x+w, y, y+h, 1);

	// Diagonals
	SetPixel(x+2, y+2, 1); SetPixel(x+3, y+3, 1);
	SetPixel(x+4, y+4, 1); SetPixel(x+5, y+5, 1);
	SetPixel(x+6, y+5, 1); SetPixel(x+7, y+4, 1);
